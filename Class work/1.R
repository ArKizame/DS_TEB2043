...
#To import csv files
data_cv = read.csv("C:/Users/ASUS/Downloads/NAexample.csv")
data_cv
data_cv2 = read.csv("C:/Users/ASUS/Downloads/my_covid.csv")
data_cv2
summary(data_cv2)
newdf<- data_cv[-seq(10, 13), ]
View(newdf)
write.csv(newdf, "C:/Users/ASUS/Downloads/my_covid.csv")
...
#Removing bad values
library(readr)
df_raw <- read.csv("C:/Users/ASUS/Downloads/ex3.csv")
df_cleaned <- df_raw
